...
style_replace = '''<link rel="stylesheet" href="../css/design-tokens.css" />
  ...
  <style>
    ...
    .control-panel {
      ...
      border-radius: 20px; padding: 22px; width: 320px; max-height: calc(100vh - 40px); overflow-y: auto;
    ...
    .panel-title {
      font-family: 'Merriweather', serif; font-size: 1.1rem; color: var(--gold); font-weight: 800;
      border-bottom: 2px solid rgba(197,160,72,0.3); padding-bottom: 8px; margin-bottom: 8px;
    }

    .control-group { display: flex; flex-direction: column; gap: 8px; }
    .control-group label { display: flex; justify-content: space-between; font-size: 0.85rem; color: var(--text-dim); font-weight: 600; }
    .control-group label span { color: var(--gold-light); font-family: 'Space Mono', monospace; font-size: 0.8rem; }
    ...
    .btn {
      flex: 1; padding: 8px; background: rgba(0,15,35,0.8); border: 1px solid rgba(197,160,72,0.4);
      color: var(--gold); border-radius: 6px; cursor: pointer; font-family: 'Space Mono', monospace; font-size: 0.8rem;
    }
    .btn:hover { background: rgba(197,160,72,0.2); }
    ...
    .dash-card {
      background: rgba(0,10,25,0.82); backdrop-filter: blur(16px);
      border: 1px solid rgba(255,255,255,0.14); border-top-color: rgba(255,255,255,0.28);
      border-radius: 14px; padding: 14px 20px; text-align: center; min-width: 140px;
    }
    .dc-label { font-family: 'Space Mono', monospace; font-size: 0.7rem; color: var(--gold); text-transform: uppercase; margin-bottom: 6px; display: block; }
    .dc-value { font-size: 1.2rem; font-weight: 700; color: var(--text); font-family: 'Space Grotesk', sans-serif; }
    
    #orbitTypeBadge {
      position: absolute; top: 20px; left: 50%; transform: translateX(-50%); z-index: 1000;
      background: rgba(0,15,35,0.85); border: 1.5px solid rgba(197,160,72,0.4); border-radius: 30px;
      padding: 10px 26px; color: var(--gold-light); font-family: 'Space Mono', monospace; font-size: 0.8rem; font-weight: 700;
      text-transform: uppercase; letter-spacing: 0.1em;
    }

    @media (max-width: 768px) {
      .control-panel { top: auto; bottom: 0; left: 0; right: 0; width: 100%; border-radius: 20px 20px 0 0; padding: 16px; max-height: 50vh; }
...
body_html = '''<body>
  ...
  <div id="orbitTypeBadge">Elliptical Orbit</div>

  <aside class="control-panel">
    <div class="panel-title">Orbital Parameters</div>
    ...
    <div class="control-group">
      <label>Semi-Major Axis (a) <span id="aVal">15.0</span></label>
      <input type="range" id="semiMajor" min="5" max="30" step="0.1" value="15">
    </div>
    ...
    <div class="panel-title" style="margin-top:10px;">Presets</div>
    <div class="btn-group">
    ...
    <div class="panel-title" style="margin-top:10px;">Visualization</div>
    <div class="control-group" style="flex-direction:row; align-items:center; gap:10px;">
      ...
      <label for="showVectors" style="margin:0;">Show Velocity Vectors</label>
    </div>
  </aside>
